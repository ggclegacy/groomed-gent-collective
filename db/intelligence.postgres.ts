...
export const intelligenceAccounts = pgTable(
...
export const intelligenceVersions = pgTable(
...
export const intelligenceNodes = pgTable(
  'intelligence_nodes',
  {
...
export const intelligenceEdges = pgTable(
  'intelligence_edges',
  {
    ownerId: text('owner_id').notNull(),
    id: text('id').notNull(),
