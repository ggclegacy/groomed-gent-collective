...
imports+=`const legacyCorpus = { version: '2026-09-05.1', reviewedAt: '2026-09-05', products: [${groups.products.join(',')}], topics: [${groups.topics.join(',')}], sources, issues } as Corpus;\nexport const corpus = mergeProductCorpus(legacyCorpus);\n`;
